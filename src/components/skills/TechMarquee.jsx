...
const TECH_LOGOS = [
  ...
  { key: "nextjs", icon: SiNextdotjs, label: "Next.js", className: "text-light-title dark:text-dark-title" },
  ...
  { key: "apollo", icon: SiApollographql, label: "Apollo Client", className: "text-[#311C87] dark:text-[#8571E5]" },
  { key: "axios", icon: SiAxios, label: "Axios", className: "text-[#5A29E4]" },
  { key: "reactrouter", icon: SiReactrouter, label: "React Router DOM", className: "text-[#CA4245]" },
  { key: "i18next", icon: SiI18Next, label: "i18next", className: "text-[#26A69A]" },
  { key: "framer", icon: SiFramer, label: "Framer Motion", className: "text-light-title dark:text-dark-title" },
  { key: "vite", icon: SiVite, label: "Vite", className: "text-[#646CFF]" },
  { key: "git", icon: FaGitAlt, label: "Git", className: "text-[#F05032]" },
  { key: "github", icon: FaGithub, label: "GitHub", className: "text-light-title dark:text-dark-title" },
